...
angular.module('userApp', ['appRoutes', 'userControllers', 'userServices', 'mainController', 'authServices', 'managementController', 'postServices', 'homeController']) // need to insert this angular application into our index to use
